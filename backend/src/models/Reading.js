...
const readingSchema = new mongoose.Schema({
  ...
  // ✅ (2026-09-18) — حالة "قطع فاتورة (חשبونية)" لكل فترة على حدة — مستقلة تماماً عن
  // حالة الدفع. تُستخدم لتوثيق إصدار فاتورة لفترة متأخرة (مثلاً مع غرامة تأخير) قبل
  // ما تُدفع فعلياً، بدل ما تبقى القراءة تظهر "غير مدفوعة" بدون أي تمييز عن الحالة
  // العادية غير المفوترة أصلاً.
  invoicedPeriods: { type: [Boolean], default: [] },
