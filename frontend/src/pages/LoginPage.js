...
export default function LoginPage({ onFarmerLogin, onAdminLogin }) {
  ...
  return (
    <div style={{
      ...
      {/* الشمس */}
      <div style={{position:'absolute',top:18,left:16,width:100,height:100}}>
        <svg className="shl-sun" style={{width:'100%',height:'100%',overflow:'visible'}} viewBox="-15 -15 120 120">
          <g fill="#FF9800">
      ...
      <svg className="shl-bird" viewBox="0 0 70 50">
      ...
      <svg style={{position:'absolute',animation:'shlBirdFly2 14s linear infinite',width:70,height:50,top:80,zIndex:2}} viewBox="0 0 70 50">
        <g style={{transform:'scaleX(-1)',transformOrigin:'35px 0'}}>
